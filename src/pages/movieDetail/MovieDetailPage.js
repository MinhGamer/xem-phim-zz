        ...
        <div className='movie-detail__content'>
          ...
          <div className='movie-detail__info'>
            ...
            <div className='movie-detail__sub-info'>
              ...
              <p>
                <span className='movie-detail__sub-info--label'>QUỐC GIA</span>
              ...
              <p>
                ...
                <span className='movie-detail__sub-info--value'>3/18/2021</span>
              </p>
            </div>

            <div className='movie-detail__description'>
              <p>
                Để đảm bảo sự hi sinh của Superman không trở thành vô ích, Bruce
                Wayne liên kết lực lượng với Diana Prince và lên kế hoạch chiêu
                mộ một đội metahuman để bảo vệ thế giới khỏi mối đe dọa thảm
                khốc đang đến gần.
              </p>
            </div>
            ...
            <div className='movie-detail__trailers'>
              {movie.trailers.map((trailer) => (
                <div className='movie-detail__trailers-item'>
                  <iframe
